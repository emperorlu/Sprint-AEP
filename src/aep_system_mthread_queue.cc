...
void aepsystem::End()
{
    ...
    cout << "[GET] nvm1_flush1_time: "   << dram_bptree1->f1time << endl;
    cout << "[GET] nvm1_flush2_time: "   << dram_bptree1->f2time << endl;
